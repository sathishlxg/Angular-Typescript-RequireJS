...
function commonConfig($httpProvider: angular.IHttpProvider, $breadcrumbProvider: any): void {
...
commonModule.config(commonConfig)
    .run(()=> { console.log("common module loaded"); });
