/// <amd-dependency path="./controllers/summary"/>
...
function getUsers(service: service.UserService): angular.IPromise<models.User[]> {
    return service.getUser();
}


loadUser.$inject = ["$stateParams", "UserService"];
function loadUser($state: any, service: service.UserService): angular.IPromise<models.User> {
