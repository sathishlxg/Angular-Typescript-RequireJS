...
;define(["require", "exports", "./common.module", "./directives/userGridFilter", "./services/BaseRepository", "./interceptor/loadingInterceptor"], function (require, exports, common_module_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
;define(["require", "exports", "angular", "ngProgress", "breadcrumb", "odata"], function (require, exports, angular) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = angular.module("userMaster.common", ["ncy-angular-breadcrumb", "ngProgress", "ODataResources"]);
});
;define(["require", "exports", "../common.module"], function (require, exports, common_module_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
;define(["require", "exports", "../common.module"], function (require, exports, common_module_1) {
    ...
    common_module_1.default.factory("AuthenticationInterceptor", AuthenticationInterceptor.Factory);
});
;define(["require", "exports", "../common.module"], function (require, exports, common_module_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    common_module_1.default.factory("loadingInterceptor", LoadingInterceptor.Factory);
});
...
;define(["require", "exports", "../user.module"], function (require, exports, user_module_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
                ...
                columnDefs: [
                    {
                        ...
                        width: 100,
                        cellTemplate: '<div class="ui-grid-cell-contents text-center"><span class="sm-status sm-status-{{ COL_FIELD }}"></span></div>',
                        filter: {
                            term: "",
                            placeholder: "Select",
                            selectOptions: [
                    ...
                    },
                    {
                        ...
                        displayName: "SPIN ID",
                        maxWidth: 250,
                        cellTemplate: '<div class="ui-grid-cell-contents"><a ui-sref="addUser({id: row.entity.id})">{{ COL_FIELD }}</a></div>'
                    },
                    {
                        name: "firstName",
                        headerCellTemplate: headerCellTmpl,
...
;define(["require", "exports", "angular", "uiGrid"], function(
  require,
  exports,
  angular
) {
